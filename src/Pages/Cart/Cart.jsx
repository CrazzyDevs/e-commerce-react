...
const CartPage = () => {
	return (
		<main className="md:w-full md:flex md:justify-evenly">
			<div className="">
				<div className="my-8 text-justify center font-bold text-xl text-[#17183B]">
					{" "}
					Cart{" "}
					<span className=" ml-3 font-normal text-base text-[#A2A3B1]">
						{" "}
						2 ITEMS
					</span>
				</div>
				<div className="flex ">
					<div className="flex gap-5">
						<div>
							<img src={Armchair} alt="chair" />
						</div>
						<div>
							<h2 className="text-[#17183B] font-bold ">
								Osmond Armchair
							</h2>
							<p className=" my-5 text-[#A2A3B1]">
								{" "}
								Color{" "}
							...
							<div className="flex">
								<p className="w-36 border rounded py-1 px-5">
									<i className="pr-5 fa fa-minus" /> 1{" "}
									<i className="fa fa-plus pl-5 " />
								</p>
			...
			<div className="border p-3 md:w-1/3 my-8">
				...
				<div className=" grid gap-4 justify-items-center">
					<div className=" w-full relative">
						<input
							className=" w-full rounded p-2 my-2 border outline-none"
							placeholder="Coupon code"
						/>
						<span className="absolute top-1 right-2 my-2 mr-2 focus:outline-none">
							<i
								className="text-lg fa fa-tag "
								aria-hidden="true"
							/>
						</span>
					</div>
