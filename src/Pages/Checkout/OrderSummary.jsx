...
function OrderSummary() {
	return (
		<div>
			<div className="order mx-1 pt-3">
				<h1 className="font-bold lg:text-2xl md:text-2xl text-3xl">
					Order Summary
				</h1>
				<div className="stock border-b border-gray-200">
					...
					<div className="flex justify-between">
						...
						<p className="lg:my-4 md:my-2 my-4 font-medium text-lg text-green-300">
							Free
						</p>
					</div>
					<div className="flex justify-between">
