  ...
  return (
    <>
      <div className="shipping">
        <div className="flex">
          <h1 className="lg:text-2xl md:text-2xl text-xl font-normal text-gray-400">
            Address
          </h1>
          <TfiAngleRight className="text-sm lg:mx-10 md:mx-10 mx-4 my-auto font-bold text-gray-400" />
          <h1 className="lg:text-xl  md:text-2xl text-xl font-semibold ">
            Shipping
          </h1>
          <TfiAngleRight className="text-sm lg:mx-10 md:mx-10 mx-4 my-auto font-bold text-gray-400" />
          <h1 className="lg:text-xl  md:text-2xl text-xl font-normal text-gray-400">
            Payment
          </h1>
        </div>
